import FCCT.Soundness

/-!
# Continuation-encoded constrained existentials
...
derived FCCT typing rules, with no extension to its syntax, subtyping, or axioms.
-/
...
theorem consumerTyping {subtyping : SubtypingContext}
    ...
    (hBody : HasType (assumeMany subtyping.bindType guards)
      (context.bindType.bind payload) body answer.weaken) :
